(function($) {
    ...
    AvailabilityCalendar.prototype = {
        ...
        __createToolbar: function() {
            ...
            this.$monthLabel = $('<span id="monthindicator"></span>').appendTo($toolbar);
            var $inputContainer = $('<span></span>').appendTo($toolbar);

            $inputContainer.append('<input type="button" class="btn-sm" title="This month" value="This Month">');
            $inputContainer.append('<input type="button" title="Previous month" value="&#10094;" style="font-size: .8rem;">');
            $inputContainer.append('<input type="button" title="Next month" value="&#10095;" style="font-size: .8rem;">');
